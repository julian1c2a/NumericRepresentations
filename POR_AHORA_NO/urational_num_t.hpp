...
class positive_rational_num_t : public std::pair<uint_num_t<B>,uint_num_t<B>>
{	
...
public:
//		CONSTRUTORES
	positive_rational_num_t()
		: fraction_t(basic_0,basic_0)	{}
	positive_rational_num_t(const basic_num_t<B> & E,const basic_num_t<B> & F) 
		: fraction_t(E,F) 	{}
	positive_rational_num_t(dig E,dig F)
		: fraction_t(uint_num(E),uint_num(F))	{}
	positive_rational_num_t(pardigs E,pardigs F)
		: fraction_t(uint_num(E),uint_num(F))	{}
	positive_rational_num_t(const uint_num & E,const uint_num & F)
		: fraction_t(uint_num(E),uint_num(F)) {}
	positive_rational_num_t(ullint E,ullint F)
		: fraction_t(uint_num(E),uint_num(F))	{}
	positive_rational_num_t(const positive_rational_num_t & alter)
		: fraction_t(alter)	{}
//		OPERADORES DE ASIGNACION
	const positive_rational_num_t & operator = (const fraction_t & E) {
		this->first = E.first;
		this->second = E.second;
		return (*this);
	}
	
	positive_rational_num_t & operator = (fraction_t & E) {
		this->first = E.first;
		this->second = E.second;
		return (*this);
	}
	
	const positive_rational_num_t & operator = (const pardigs & E) {
		this->first.clear();
	...
	positive_rational_num_t & operator = (pardigs & E) {
		this->first.clear();
		this->first.push_back(E.first);
		this->second.clear();
		this->second.push_back(E.second);
	...
	const positive_rational_num_t & operator = (const parpardigs & E) {
		this->first.clear();
	...
	positive_rational_num_t & operator = (parpardigs & E) {
		this->first.clear();
		this->first.push_back(E.first.first);
		this->first.push_front(E.first.second);
		this->second.clear();
	...
	const positive_rational_num_t & operator = (const parullint & E) {
		this->first.clear();
	...
	positive_rational_num_t & operator = (parullint & E)  {
		this->first.clear();
		this->first.push_back(dig(ullint(E.first)));
		this->second.clear();
		this->second.push_back(dig(ullint(E.second)));
	...
	const positive_rational_num_t & operator = (const positive_rational_num_t & alter) {
		this->first = alter.first; 
		this->second = alter.second;
		return (*this);
	}
	
	positive_rational_num_t & operator = (positive_rational_num_t & alter)  {
		this->first = alter.first; 
		this->second = alter.second;
		return (*this);
	}
...
// COMPARACIONES
	...
	bool operator ==(const positive_rational_num_t & arg) const {
...
// OPERACIONES DE COMPLEMENTO
	positive_rational_num_t C_B() const {
		positive_rational_num_t ret(*this);
		ret.first.mC_Bm1();
		ret.second.mC_Bm1();
